...
const SLIDES: Slide[] = [
  {
    ...
    body: "All your holdings in one place — balances, prices, and how they've changed.",
  },
  {
    id: "trade",
    variant: "art",
    art: <TokenRowsArt />,
    title: "Invest in any\ntoken.",
    body: "50+ tokens available. Enter an amount, confirm in World App. Routed through Uniswap V3.",
  },
  {
    id: "insights",
    variant: "art",
    art: <InsightArt />,
    title: "See what\nchanged.",
    body: "Every time you open the app, see what moved since you last looked.",
  },
  {
    id: "honest",
    variant: "list",
    title: "Worth\nknowing.",
    points: [
      "World Chain only — no other chains are supported",
      "Balances are read directly from the blockchain",
      "Some historical performance figures are estimated",
    ],
  },
];
